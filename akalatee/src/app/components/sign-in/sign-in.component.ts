...
export class SignInComponent implements OnInit {
  ...
  // FUNCTIONS
  constructor( private statusS : StatusService , private fb : FormBuilder , private userS : UserService , private router : Router ) 
  { 
  ...
  sign_in()
  {
    ...
    else
    {
      ...
      setTimeout( ()=>{ this.alert_message_status = false; } , 2000 );
